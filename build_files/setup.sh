...
install -Dm644 /prepare/conf/pacman/pacman.conf           /etc/pacman.conf
install -Dm644 /prepare/conf/pacman/mirrorlist            /etc/pacman.d/mirrorlist
install -Dm755 /prepare/files/install-cachy.sh            /tmp/install-cachy.sh
